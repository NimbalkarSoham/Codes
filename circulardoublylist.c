...
void insertAtBeginning(int toInsert)
{
...
void insertBeforeVal(int toInsert, int val)
{
...
void insertAfterVal(int toInsert, int val)
{
...
void insertAtPosition(int toInsert, int pos)
{
    ...
    else if (ptr->next == start && count < pos)
    { // inserting after last node  /* second condition => when the postion is second-last */
        insertAtEnd(toInsert);
    }
    else
...
{ // Deletes elements at the beginning
...
void updateAtBeginning(int toUpdate)
...
void updateBeforeVal(int toUpdate, int val)
{ // updates before val
...
void updateAfterVal(int toUpdate, int val)
{ // update after val is encountered
...
void updateAtPosition(int toUpdate, int pos)
{ // updates at posiotion
